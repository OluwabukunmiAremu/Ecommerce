    ...
    <div className='container py-10'>
        ...
        HeroData.map((data) => (
            <div key={data.id}>
                ...
                <div className="flex flex-col justify-center gap-4 sm:pl-3 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1  order relative z-10 ">
                    <h1
                      data-aos="zoom-out"
                ...
                {/* Img Section */}
                    <div className=' order-1 order sm:order-2'>
                    <div
                       data-aos="zoom-in"
                       data-aos-once="true"
